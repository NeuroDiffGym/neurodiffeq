...
from neurodiffeq.temporal import generator_1dspatial, generator_temporal, generator_2dspatial_segment
...
from neurodiffeq.temporal import _train_1dspatial_temporal, _valid_1dspatial_temporal
import matplotlib
