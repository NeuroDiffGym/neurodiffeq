...
class Generator1D(BaseGenerator):
    ...
    :param method:
        ...
        - If set to 'latin_hypercube', the generator will create points using Latin Hypercube Sampling from t_min to t_max.
...
class Generator2D(BaseGenerator):
    r"""An example generator for generating 2-D training points.
        ...
        :param method:
            ...
            - If set to 'latin-hypercube', the points will be generated using Latin Hypercube Sampling.
    ...
    def __init__(self, grid=(10, 10), r_min=(0.0, 0.0), r_max=(1.0, 1.0),
        ...
        for i in range(N):
            ...
            if method == 'equally-spaced':
                ...
                x = _latin_hypercube(r_min[i], r_max[i], grid[i])
                noise_rstd_tensor = noise_rstd * torch.ones(x.size())
            else:
                raise ValueError(f'Unknown method: {method}')
