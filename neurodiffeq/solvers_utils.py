...
class UniversalPretrainedSolver():
    ...
    def save(self,
        ...
        diff_equation_details = {
            ...
            "parameters": get_parameters(self.diff_eqs),
            "conditions": [],
            "equation_tex": UniversalPretrainedSolver.get_diff_eqs(self)["equation_tex"],
            "t_tex": UniversalPretrainedSolver.get_diff_eqs(self)["t_tex"],
            "u_tex": UniversalPretrainedSolver.get_diff_eqs(self)["u_tex"],
            # "generator": get_generator(self.generator),
            # "sample_solution": {},
            # "sample_loss": self.metrics_history['valid_loss'],
            # "criterion": get_source(self.criterion),
