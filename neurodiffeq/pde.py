...
def solve2D(
        ...
        net=None, train_generator=None, shuffle=True, valid_generator=None, optimizer=None,
        criterion=None, additional_loss_term=None, n_batches_train=1, n_batches_valid=4,
        metrics=None, batch_size=16, max_epochs=1000,
